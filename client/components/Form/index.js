...
export default class Form extends React.Component{
  ...
  submitFunction(e){
    e.preventDefault();
    let checkNum4 = document.getElementById("ccNumber").value.substring(0,4).trim();
    let checkNum2 = document.getElementById("ccNumber").value.substring(0,2).trim();
